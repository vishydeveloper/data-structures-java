 ...
 * @author Micah Stairs
 */
package com.datastructures.segmenttree;
...
public class Node {
    ...
    public Node(int[] values) {
        if (values == null) throw new IllegalArgumentException("Null input to segment leetcode.tree.");
    ...
    // Recursive method that builds the segment leetcode.tree
