...
public final class StdOut {
    ...
    /**
     * Terminates the current line by printing the line-separator leetcode.string.
     */
    ...
    /**
     * Prints a formatted leetcode.string to standard output, using the specified format
     * leetcode.string and arguments, and then flushes standard output.
     *
     *
     * @param format the <a href = "http://docs.oracle.com/javase/7/docs/api/java/util/Formatter.html#syntax">format leetcode.string</a>
     * @param args   the arguments accompanying the format leetcode.string
     */
    ...
    /**
     * Prints a formatted leetcode.string to standard output, using the locale and
     * the specified format leetcode.string and arguments; then flushes standard output.
     *
