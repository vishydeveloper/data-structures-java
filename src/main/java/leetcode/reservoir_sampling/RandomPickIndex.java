package leetcode.reservoir_sampling;

import java.util.Random;

/**
 * Created by gouthamvidyapradhan on 10/12/2017. Given an leetcode.array of integers with possible
 * duplicates, randomly output the index of a given target number. You can assume that the given
 * target number must exist in the leetcode.array.
 *
 * <p>Note: The leetcode.array size can be very large. Solution that uses too much extra space will not pass
 * the judge.
 *
 * <p>Example:
 *
 ...
 *
 * <p>// pick(1) should return 0. Since in the leetcode.array only nums[0] is equal to 1. solution.pick(1);
 */
