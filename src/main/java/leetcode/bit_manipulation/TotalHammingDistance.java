 ...
 * HammingDistance(4, 2) + HammingDistance(14, 2) = 2 + 2 + 2 = 6. Note: Elements of the given leetcode.array
 * are in the range of 0 to 10^9 Length of the leetcode.array will not exceed 10^4.
 *
