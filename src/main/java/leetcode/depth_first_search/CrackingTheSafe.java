 ...
 * total of 6 digits.
 *
 * <p>Please return any leetcode.string of minimum length that is guaranteed to open the box after the entire
 * leetcode.string is inputted.
 *
 ...
 * with-in the given range k. Maintain a 'result' leetcode.string and keep appending the new digit in every
 * state, if the total number of states visited reaches k ^ n then, the result leetcode.string will be the
 * answer.
 */
