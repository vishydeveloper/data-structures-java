 ...
 * proceed without checking if the node has already been visited. Maintain a leetcode.stack to keep track of
 * the path and when a leaf node has been reached add the elements in the leetcode.stack to the result leetcode.array
 */
