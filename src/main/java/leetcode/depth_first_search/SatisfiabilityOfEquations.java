...
/**
 * Created by gouthamvidyapradhan on 25/07/2019 Given an leetcode.array equations of strings that represent
 * relationships between variables, each leetcode.string equations[i] has length 4 and takes one of two
