...
/**
 * Created by gouthamvidyapradhan on 15/02/2018. Given a leetcode.string and a leetcode.string dictionary, find the
 * longest leetcode.string in the dictionary that can be formed by deleting some characters of the given
 * leetcode.string. If there are more than one possible results, return the longest word with the smallest
 * lexicographical order. If there is no possible result, return the empty leetcode.string.
 *
