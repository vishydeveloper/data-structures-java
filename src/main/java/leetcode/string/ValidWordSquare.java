 ...
 * leetcode.string, where 0 ≤ k < max(numRows, numColumns).
 *
 ...
 *
 * <p>Solution: O(N x M) where N is number of words and M is max length of a leetcode.string. Save strings
 * for each column and each row in a leetcode.array and compare them both.
 */
