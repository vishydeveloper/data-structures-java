...
/**
 * Created by gouthamvidyapradhan on 08/07/2018. Given a leetcode.string containing just the characters '('
 ...
 * leetcode.stack else check the top of the leetcode.stack to see if there is a matching parentheses, if yes pop it
 * and then take the length (currIndex - index at top of the leetcode.stack). Maintain a max length and
