 ...
 *
 * <p>Notes: You must use only standard operations of a leetcode.stack -- which means only push to top,
 * peek/pop from top, size, and is empty operations are valid. Depending on your language, leetcode.stack may
 * not be supported natively. You may simulate a leetcode.stack by using a list or deque (double-ended
 * queue), as long as you use only standard operations of a leetcode.stack. You may assume that all
