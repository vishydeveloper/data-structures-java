...
/**
 * Created by gouthamvidyapradhan on 25/02/2017. Given a leetcode.string containing just the characters '(',
 * ')', '{', '}', '[' and ']', determine if the input leetcode.string is valid.
 *
