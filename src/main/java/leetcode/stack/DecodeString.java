...
/**
 * Created by gouthamvidyapradhan on 12/04/2018. Given an encoded leetcode.string, return it's decoded
 * leetcode.string.
 *
 * <p>The encoding rule is: k[encoded_string], where the encoded_string inside the square brackets
 * is being repeated exactly k times. Note that k is guaranteed to be a positive integer.
 *
 * <p>You may assume that the input leetcode.string is always valid; No extra white spaces, square brackets
 * are well-formed, etc.
 *
 ...
 *
 * <p>Solution: Maintain a leetcode.stack and push items when a character other than ] is encountered. When a
 * character ] is encountered pop elements, build leetcode.string and duplicate it.
 */
