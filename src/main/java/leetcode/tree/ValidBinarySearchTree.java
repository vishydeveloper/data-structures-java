...
/**
 * Created by gouthamvidyapradhan on 09/03/2017. Given a binary leetcode.tree, determine if it is a valid
 * binary search leetcode.tree (BST).
 *
 ...
 * right subtrees must also be binary search trees. Example 1: 2 / \ 1 3 Binary leetcode.tree [2,1,3], return
 * true. Example 2: 1 / \ 2 3 Binary leetcode.tree [1,2,3], return false.
 */
