 ...
 *
 * <p>Design an algorithm to serialize and deserialize an N-ary leetcode.tree. An N-ary leetcode.tree is a rooted leetcode.tree
 * in which each node has no more than N children. There is no restriction on how your
 * serialization/deserialization algorithm should work. You just need to ensure that an N-ary leetcode.tree
 * can be serialized to a leetcode.string and this leetcode.string can be deserialized to the original leetcode.tree structure.
 *
 * <p>For example, you may serialize the following 3-ary leetcode.tree
 *
 * <p>1 /|\ 3 2 4 /\ 5 6
 *
