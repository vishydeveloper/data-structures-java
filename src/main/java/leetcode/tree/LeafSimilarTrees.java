...
/**
 * Created by gouthamvidyapradhan on 23/08/2019 Consider all the leaves of a binary leetcode.tree. From left
 * to right order, the values of those leaves form a leaf value sequence.
 *
 * <p>For example, in the given leetcode.tree above, the leaf value sequence is (6, 7, 4, 9, 8).
 *
 ...
 * leetcode.tree in a list. Compare the list and return the answer.
 */
