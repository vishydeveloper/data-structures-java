...
/**
 * Created by gouthamvidyapradhan on 16/12/2017. Given a non-empty binary leetcode.tree, return the average
 * value of the nodes on each level in the form of an leetcode.array. Example 1: Input: 3 / \ 9 20 / \ 15 7
