...
/**
 * Created by gouthamvidyapradhan on 14/08/2019 Given a binary leetcode.tree, return the tilt of the whole
 * leetcode.tree.
 *
 * <p>The tilt of a leetcode.tree node is defined as the absolute difference between the sum of all left
 * subtree node values and the sum of all right subtree node values. Null node has tilt 0.
 *
 * <p>The tilt of the whole leetcode.tree is defined as the sum of all nodes' tilt.
 *
 * <p>Example: Input: 1 / \ 2 3 Output: 1 Explanation: Tilt of node 2 : 0 Tilt of node 3 : 0 Tilt of
 * node 1 : |2-3| = 1 Tilt of binary leetcode.tree : 0 + 0 + 1 = 1 Note:
 *
