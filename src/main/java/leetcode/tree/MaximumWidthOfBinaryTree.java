...
/**
 * Created by gouthamvidyapradhan on 03/05/2018. Given a binary leetcode.tree, write a function to get the
 * maximum width of the given leetcode.tree. The width of a leetcode.tree is the maximum width among all levels. The
 * binary leetcode.tree has the same structure as a full binary leetcode.tree, but some nodes are null.
 *
