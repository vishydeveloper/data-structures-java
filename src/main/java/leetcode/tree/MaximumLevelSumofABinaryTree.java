...
/**
 * Created by gouthamvidyapradhan on 28/08/2019 Given the root of a binary leetcode.tree, the level of its
 ...
 * <p>Note:
 *
 * <p>The number of nodes in the given leetcode.tree is between 1 and 10^4. -10^5 <= node.val <= 10^5
 *
 * <p>Solution: Keep a hashmap key-value pairs where key is the level and value is the sum of values
 * at that level, do a inorder search in the leetcode.tree and sum up the values at each level.
 */
