 ...
 *
 * <p>What if the given leetcode.tree could be any binary leetcode.tree? Would your previous solution still work?
 *
 * <p>Note:
 *
 * <p>You may only use constant extra space. For example, Given the following binary leetcode.tree, 1 / \ 2 3
 * / \ \ 4 5 7 After calling your function, the leetcode.tree should look like: 1 -> NULL / \ 2 -> 3 -> NULL
 * / \ \ 4-> 5 -> 7 -> NULL
 */
