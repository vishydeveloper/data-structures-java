...
/**
 * Created by gouthamvidyapradhan on 30/08/2017. Given a binary leetcode.tree, find the leftmost value in the
 * last row of the leetcode.tree.
 *
 * <p>Example 1: Input:
 *
 * <p>2 / \ 1 3
 ...
 * <p>1 / \ 2 3 / / \ 4 5 6 / 7
 *
 * <p>Output: 7 Note: You may assume the leetcode.tree (i.e., the given root node) is not NULL. Solution:
