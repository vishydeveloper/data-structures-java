...
/**
 * Created by pradhang on 7/11/2017. Given a binary leetcode.tree, return the zigzag level order traversal of
 * its nodes' values. (ie, from left to right, then right to left for the next level and alternate
 * between).
 *
 * <p>For example: Given binary leetcode.tree [3,9,20,null,null,15,7], 3 / \ 9 20 / \ 15 7 return its zigzag
