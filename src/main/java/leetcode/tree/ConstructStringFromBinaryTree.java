...
/**
 * Created by gouthamvidyapradhan on 10/06/2017. Accepted You need to construct a leetcode.string consists of
 * parenthesis and integers from a binary leetcode.tree with the preorder traversing way.
 *
 ...
 * leetcode.string and the original binary leetcode.tree.
 *
 * <p>Example 1: Input: Binary leetcode.tree: [1,2,3,4] 1 / \ 2 3 / 4
 *
 * <p>Output: "1(2(4))(3)"
 *
 * <p>Explanation: Originallay it needs to be "1(2(4)())(3()())", but you need to omit all the
 * unnecessary empty parenthesis pairs. And it will be "1(2(4))(3)". Example 2: Input: Binary leetcode.tree:
