...
/**
 * Created by gouthamvidyapradhan on 14/05/2017. Given a binary search leetcode.tree and a node in it, find
 * the in-order successor of that node in the BST.
 *
 * <p>Note: If the given node has no in-order successor in the leetcode.tree, return null.
 *
 * <p>Solution: The below solution works with worst case time complexity of O(h) where h is the
 * height of the leetcode.tree. If the current node is <= target_node, recursively iterate the right of the
