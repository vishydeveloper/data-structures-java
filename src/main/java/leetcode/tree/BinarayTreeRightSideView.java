...
/**
 * Created by gouthamvidyapradhan on 12/03/2017. Given a binary leetcode.tree, imagine yourself standing on
 * the right side of it, return the values of the nodes you can see ordered from top to bottom.
 *
 * <p>For example: Given the following binary leetcode.tree, 1 <--- / \ 2 3 <--- \ \ 5 4 <--- You should
 * return [1, 3, 4].
 */
