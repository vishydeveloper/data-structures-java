...
/**
 * Created by gouthamvidyapradhan on 14/08/2017. Given a binary leetcode.tree, check whether it is a mirror
 * of itself (ie, symmetric around its center).
 *
 * <p>For example, this binary leetcode.tree [1,2,2,3,4,4,3] is symmetric:
 *
 * <p>1 / \ 2 2 / \ / \ 3 4 4 3
 *
