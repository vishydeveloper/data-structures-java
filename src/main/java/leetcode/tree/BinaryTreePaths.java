...
/**
 * Created by gouthamvidyapradhan on 09/12/2017. Given a binary leetcode.tree, return all root-to-leaf paths.
 *
 * <p>For example, given the following binary leetcode.tree:
 *
