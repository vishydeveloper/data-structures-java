...
/**
 * Created by gouthamvidyapradhan on 02/03/2019 You are given a leetcode.string, s, and a list of words,
 ...
 *
 * <p>Solution: General idea is to do the following 1. Calculate the word count for the given leetcode.array
 ...
 * given original word list then add the starting index of this substring into the result leetcode.array.
 *
