 ...
 * should occur before y in the returned leetcode.string.
 *
 * <p>Return any permutation of T (as a leetcode.string) that satisfies this property.
 *
 ...
 *
 * <p>Solution: O(N) count occurrence of each character and write to the output leetcode.string
 */
