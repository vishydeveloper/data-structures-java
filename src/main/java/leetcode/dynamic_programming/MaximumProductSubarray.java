...
/**
 * Created by gouthamvidyapradhan on 02/04/2017. Find the contiguous subarray within an leetcode.array
 * (containing at least one number) which has the largest product.
 *
 * <p>For example, given the leetcode.array [2,3,-2,4], the contiguous subarray [2,3] has the largest product
 * = 6.
 */
