 ...
 * integer k, write a function to check if the leetcode.array has a continuous subarray of size at least 2
 ...
 * Note: The length of the leetcode.array won't exceed 10,000. You may assume the sum of all the numbers is
