 ...
 * {1,1}]).
 *
 * <p>Given an leetcode.array houses, an m * n matrix cost and an integer target where:
 *
 ...
 * = 3 Output: 9 Explanation: Paint houses of this way [1,2,2,1,1] This leetcode.array contains target = 3
 ...
 * [2,2,1,2,2] This leetcode.array contains target = 3 neighborhoods, [{2,2}, {1}, {2,2}]. Cost of paint the
