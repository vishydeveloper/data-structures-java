...
/**
 * Created by gouthamvidyapradhan on 15/09/2019 Given a non-empty leetcode.string, encode the leetcode.string such
 ...
 * <p>Note:
 *
 * <p>k will be a positive integer and encoded leetcode.string will not be empty or have extra space. You may
 * assume that the input leetcode.string contains only lowercase English letters. The leetcode.string's length is at
 * most 160. If an encoding process does not make the leetcode.string shorter, then do not encode it. If
 ...
 * than the input leetcode.string, so we do not encode it.
 *
 * <p>Example 2:
 *
 ...
 *
 * <p>Solution: O(N ^ 4) Maintain a 2d String leetcode.array of minimum substring and split each substring
