...
/**
 * Created by gouthamvidyapradhan on 05/04/2020 You have a pointer at index 0 in an leetcode.array of size
 * arrLen. At each step, you can move 1 position to the left, 1 position to the right in the leetcode.array
 * or stay in the same place (The pointer should not be placed outside the leetcode.array at any time).
 *
 ...
 * state is a combination of position in the leetcode.array and the number of steps. From every state we can
