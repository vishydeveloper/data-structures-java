 ...
 *
 * <p>Each a_i is a non-empty leetcode.string; Their concatenation a_1 + a_2 + ... + a_k is equal to text;
 * For all 1 <= i <= k, a_i = a_{k+1 - i}.
 *
 * <p>Example 1:
 *
 * <p>Input: text = "ghiabcdefhelloadamhelloabcdefghi" Output: 7 Explanation: We can split the
 * leetcode.string on "(ghi)(abcdef)(hello)(adam)(hello)(abcdef)(ghi)". Example 2:
 *
 * <p>Input: text = "merchant" Output: 1 Explanation: We can split the leetcode.string on "(merchant)".
 * Example 3:
 *
 * <p>Input: text = "antaprezatepzapreanta" Output: 11 Explanation: We can split the leetcode.string on
 * "(a)(nt)(a)(pre)(za)(tpe)(za)(pre)(a)(nt)(a)". Example 4:
 *
 * <p>Input: text = "aaa" Output: 3 Explanation: We can split the leetcode.string on "(a)(a)(a)".
 *
 * <p>Constraints:
 *
