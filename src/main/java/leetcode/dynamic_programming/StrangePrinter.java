 ...
 * original existing characters. Given a leetcode.string consists of lower English letters only, your job is
 ...
 * second place of the leetcode.string, which will cover the existing character 'a'. Hint: Length of the
 * given leetcode.string will not exceed 100.
 */
