 ...
 *
 * <p>In a given leetcode.array nums of positive integers, find three non-overlapping subarrays with maximum
 * sum.
 *
 ...
 *
 * <p>Solution: O(N) solution by prefix and reverse-prefix sum First calculate max index for leetcode.array
 * index k, then use this to calculate max index for two leetcode.array indices j and k and again use this
