...
/**
 * Created by gouthamvidyapradhan on 22/04/2020 You are given a leetcode.string s containing lowercase
 ...
 * of characters that you need to change to divide the leetcode.string.
 *
 * <p>Example 1:
 *
 * <p>Input: s = "abc", k = 2 Output: 1 Explanation: You can split the leetcode.string into "ab" and "c", and
 * change 1 character in "ab" to make it palindrome. Example 2:
 *
 * <p>Input: s = "aabbc", k = 3 Output: 0 Explanation: You can split the leetcode.string into "aa", "bb" and
