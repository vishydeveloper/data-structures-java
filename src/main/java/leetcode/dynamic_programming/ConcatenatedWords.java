 ...
 * words.
 *
 * <p>A concatenated word is defined as a leetcode.string that is comprised entirely of at least two shorter
 * words in the given leetcode.array.
 *
 * <p>Example: Input:
 ...
 * "dog" and "cat".
 *
 * <p>Note: The number of elements of the given leetcode.array will not exceed 10,000 The length sum of
 * elements in the given leetcode.array will not exceed 600,000. All the input leetcode.string will only include lower
