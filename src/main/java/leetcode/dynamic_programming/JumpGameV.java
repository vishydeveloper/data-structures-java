...
/**
 * Created by gouthamvidyapradhan on 18/02/2020 Given an leetcode.array of integers arr and an integer d. In
 ...
 *
 * <p>You can choose any index of the leetcode.array and start jumping. Return the maximum number of indices
 * you can visit.
 *
 * <p>Notice that you can not jump outside of the leetcode.array at any time.
 *
 * <p>Example 1:
 *
