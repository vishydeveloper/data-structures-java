...
/**
 * Created by gouthamvidyapradhan on 24/12/2017. Given an leetcode.array which consists of non-negative
 * integers and an integer m, you can split the leetcode.array into m non-empty continuous subarrays. Write
 * an algorithm to minimize the largest sum among these m subarrays.
 *
 * <p>Note: If n is the length of leetcode.array, assume the following constraints are satisfied:
 *
 ...
 *
 * <p>Solution O(n ^ 2 * k) Build a bottom up min-max dp table for each sub-leetcode.array ranging from n ->
 * 0
 */
