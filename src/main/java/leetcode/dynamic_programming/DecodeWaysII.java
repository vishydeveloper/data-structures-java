 ...
 *
 * <p>'A' -> 1 'B' -> 2 ... 'Z' -> 26 Beyond that, now the encoded leetcode.string can also contain the
 ...
 *
 * <p>Example 1: Input: "*" Output: 9 Explanation: The encoded message can be decoded to the leetcode.string:
 * "A", "B", "C", "D", "E", "F", "G", "H", "I". Example 2: Input: "1*" Output: 9 + 9 = 18 Note: The
 * length of the input leetcode.string will fit in range [1, 105]. The input leetcode.string will only contain the
