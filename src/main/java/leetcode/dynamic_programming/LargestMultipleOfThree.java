...
/**
 * Created by gouthamvidyapradhan on 29/05/2020 Given an integer leetcode.array of digits, return the largest
 * multiple of three that can be formed by concatenating some of the given digits in any order.
 *
 * <p>Since the answer may not fit in an integer data type, return the answer as a leetcode.string.
 *
 * <p>If there is no answer return an empty leetcode.string.
 *
 * <p>Example 1:
 *
