 ...
 *
 * <p>Given a leetcode.string ring, which represents the code engraved on the outer ring and another leetcode.string
 ...
 * all the characters in the leetcode.string key one by one by rotating the ring clockwise or anticlockwise
 * to make each character of the leetcode.string key aligned at 12:00 direction and then by pressing the
 * center button.
 *
 ...
 * final purpose of the rotation is to align one of the leetcode.string ring's characters at the 12:00
 ...
 * both strings and might be some duplcate characters in both strings. It's guaranteed that leetcode.string
 * key could always be spelled by rotating the leetcode.string ring.
 */
