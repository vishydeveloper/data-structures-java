 ...
 *
 * <p>Solution O(n x m ^ 2) where m is the average length of each leetcode.string and n is the number of
 * strings.
 */
  ...
  public class Trie {
    ...
    private void add(int i, String word, int length, int pos) {
      if (i < length) {
        ...
        Trie t = new Trie();
        t.index = pos;
        map.put(null, t); // use null to indicate end of leetcode.string
      }
    }
