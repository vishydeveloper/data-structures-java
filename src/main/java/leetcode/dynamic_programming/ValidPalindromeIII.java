...
/**
 * Created by gouthamvidyapradhan on 23/04/2020 Given a leetcode.string s and an integer k, find out if the
 * given leetcode.string is a K-Palindrome or not.
 *
 * <p>A leetcode.string is K-Palindrome if it can be transformed into a palindrome by removing at most k
 * characters from it.
 *
 * <p>Example 1:
 *
