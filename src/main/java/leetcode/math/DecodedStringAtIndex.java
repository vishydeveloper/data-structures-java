...
/**
 * Created by gouthamvidyapradhan on 21/07/2019 An encoded leetcode.string S is given. To find and write the
 * decoded leetcode.string to a tape, the encoded leetcode.string is read one character at a time and the following
 * steps are taken:
 *
 ...
 * for some encoded leetcode.string S, and an index K, find and return the K-th letter (1 indexed) in the
 * decoded leetcode.string.
 *
 * <p>Example 1:
 *
 * <p>Input: S = "leet2code3", K = 10 Output: "o" Explanation: The decoded leetcode.string is
 * "leetleetcodeleetleetcodeleetleetcode". The 10th letter in the leetcode.string is "o". Example 2:
 *
 * <p>Input: S = "ha22", K = 5 Output: "h" Explanation: The decoded leetcode.string is "hahahaha". The 5th
 * letter is "h". Example 3:
 *
 * <p>Input: S = "a2345678999999999999999", K = 1 Output: "a" Explanation: The decoded leetcode.string is "a"
 ...
 * with a letter. 1 <= K <= 10^9 The decoded leetcode.string is guaranteed to have less than 2^63 letters.
 *
