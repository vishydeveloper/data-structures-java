...
/**
 * Created by gouthamvidyapradhan on 18/03/2017. Given an leetcode.array of integers A and let n to be its
 * length.
 *
 * <p>Assume Bk to be an leetcode.array obtained by rotating the leetcode.array A k positions clock-wise, we define a
