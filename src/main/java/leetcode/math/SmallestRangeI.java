...
/**
 * Created by gouthamvidyapradhan on 22/08/2019 Given an leetcode.array A of integers, for each integer A[i]
 * we may choose any x with -K <= x <= K, and add x to A[i].
 *
 * <p>After this process, we have some leetcode.array B.
 *
