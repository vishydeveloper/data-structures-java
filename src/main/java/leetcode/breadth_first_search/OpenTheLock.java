 ...
 *
 * <p>The lock initially starts at '0000', a leetcode.string representing the state of the 4 wheels.
 *
 ...
 * target will not be in the list deadends. Every leetcode.string in deadends and the leetcode.string target will be a
 * leetcode.string of4 digits from the 10,000 possibilities '0000' to '9999'.
 *
