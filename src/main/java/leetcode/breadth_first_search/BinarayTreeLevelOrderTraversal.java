...
/**
 * Created by gouthamvidyapradhan on 13/03/2017. Given a binary leetcode.tree, return the level order
 * traversal of its nodes' values. (ie, from left to right, level by level).
 *
 * <p>For example: Given binary leetcode.tree [3,9,20,null,null,15,7], 3 / \ 9 20 / \ 15 7 return its level
