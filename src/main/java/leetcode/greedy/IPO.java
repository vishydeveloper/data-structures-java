 ...
 * finish at most k distinct projects before the IPO. Help LeetCode leetcode.design the best way to maximize
 ...
 * non-negative integers. The length of Profits leetcode.array and Capital leetcode.array will not exceed 50,000. The
 * answer is guaranteed to fit in a 32-bit signed integer.
 *
 * <p>Solution: O(N log N) where N is the size of Capital/Profit leetcode.array. General intuition is to pick
