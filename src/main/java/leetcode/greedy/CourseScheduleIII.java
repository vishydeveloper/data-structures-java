 ...
 * a max-leetcode.heap of course duration. 3. Iterate through each course and increment the total time by
 * current course time and include this in the max-leetcode.heap created in step 2. 4. If the total time
 * exceeds the current course deadline then, remove the course with max duration from max-leetcode.heap
