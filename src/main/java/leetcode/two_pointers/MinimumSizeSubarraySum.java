 ...
 *
 * <p>Given an leetcode.array of n positive integers and a positive integer s, find the minimal length of a
 * contiguous subarray of which the sum ≥ s. If there isn't one, return 0 instead.
 *
 * <p>For example, given the leetcode.array [2,3,1,2,4,3] and s = 7, the subarray [4,3] has the minimal
 ...
 *
 * <p>Solution: O(n) solution. Solve using sliding window sub-leetcode.array sum using two pointers.
 */
