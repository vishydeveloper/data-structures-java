...
/**
 * Created by gouthamvidyapradhan on 30/08/2019 Given a leetcode.string s, return the last substring of s in
 ...
 * iterating the leetcode.string character by character, if a char is encountered with is greater than the
