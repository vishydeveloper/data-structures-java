...
/**
 * Created by gouthamvidyapradhan on 13/06/2017. Accepted Given an leetcode.array S of n integers, find three
 * integers in S such that the sum is closest to a given number, target. Return the sum of the three
 * integers. You may assume that each input would have exactly one solution.
 *
 * <p>For example, given leetcode.array S = {-1 2 1 -4}, and target = 1.
 *
