...
/**
 * Created by gouthamvidyapradhan on 20/05/2017. Given an leetcode.array of integers sorted in ascending
 ...
 *
 * <p>If the target is not found in the leetcode.array, return [-1, -1].
 *
...
public class SearchForARange {
   ...
   * Find index
   *
   * @param nums nums leetcode.array
   * @param target target
