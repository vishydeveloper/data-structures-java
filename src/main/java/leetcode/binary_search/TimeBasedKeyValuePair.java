 ...
 *
 * <p>1. set(leetcode.string key, leetcode.string value, int timestamp)
 *
 * <p>Stores the key and value, along with the given timestamp. 2. get(leetcode.string key, int timestamp)
 *
 ...
 * largest timestamp_prev. If there are no values, it returns the empty leetcode.string ("").
 *
 * <p>Example 1:
 *
