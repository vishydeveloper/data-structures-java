...
/**
 * Created by gouthamvidyapradhan on 22/05/2017. Given a sorted leetcode.array and a target value, return the
 * index if the target is found. If not, return the index where it would be if it were inserted in
 * order.
 *
 * <p>You may assume no duplicates in the leetcode.array.
 *
