 ...
 *
 * <p>Design an algorithm to serialize and deserialize a binary leetcode.tree. There is no restriction on how
 * your serialization/deserialization algorithm should work. You just need to ensure that a binary
 * leetcode.tree can be serialized to a leetcode.string and this leetcode.string can be deserialized to the original leetcode.tree
 * structure.
 *
 * <p>For example, you may serialize the following leetcode.tree
 *
 * <p>1 / \ 2 3 / \ 4 5 as "[1,2,3,null,null,4,5]", just the same as how LeetCode OJ serializes a
 * binary leetcode.tree. You do not necessarily need to follow this format, so please be creative and come up
