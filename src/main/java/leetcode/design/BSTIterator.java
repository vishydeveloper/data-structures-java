...
/**
 * Created by gouthamvidyapradhan on 13/08/2017. Implement an iterator over a binary search leetcode.tree
 ...
 * the height of the leetcode.tree.
 *
 * <p>Solution: The below solution works in average O(1) time and worst case O(h) time using O(h)
 * memory. Use a leetcode.stack to keep track of min value node.
 */
public class BSTIterator {
  ...
  /**
   * Fill leetcode.stack with min values
   *
