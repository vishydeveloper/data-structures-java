 ...
 *
 * <p>Your task is to leetcode.design the basic function of Excel and implement the function of sum formula.
 ...
 * 'A' to W. The Excel form content is represented by a height * width 2D integer leetcode.array C, it should
 ...
 *
 * <p>numbers is a list of strings that each leetcode.string represent a cell or a range of cells. If the
 * leetcode.string represent a single cell, then it has the following format : ColRow. For example, "F7"
 * represents the cell at (7, F).
 *
 * <p>If the leetcode.string represent a range of cells, then it has the following format : ColRow1:ColRow2.
 ...
 * <p>
 *
 * <p>Example 1: Excel(3,"C"); // construct a 3*3 2D leetcode.array with all zero. // A B C // 1 0 0 0 // 2 0
 * 0 0 // 3 0 0 0
 *
