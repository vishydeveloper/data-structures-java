...
/**
 * Created by gouthamvidyapradhan on 27/11/2017. Given an leetcode.array of meeting time intervals consisting
 ...
 *
 * <p>Solution: Sort the leetcode.array based on start-time of the interval. Then, use the min-leetcode.heap based on
