...
/**
 * Created by gouthamvidyapradhan on 12/12/2017. Given an leetcode.array of citations (each citation is a
 ...
 * change with this operation. Maintain a count leetcode.array with count of each citations. Sum up all the
 * counts from n -> 0 and store this in a leetcode.array S. Value in leetcode.array index Si is number of papers
 * having citations at least i.
 *
 * <p>The first value at index i, from right to left in leetcode.array S which has i <= Si is the answer.
 */
public class HIndex {
