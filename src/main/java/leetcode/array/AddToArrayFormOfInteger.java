 ...
 *
 * <p>For a non-negative integer X, the leetcode.array-form of X is an leetcode.array of its digits in left to right
 * order. For example, if X = 1231, then the leetcode.array form is [1,2,3,1].
 *
 * <p>Given the leetcode.array-form A of a non-negative integer X, return the leetcode.array-form of the integer X+K.
 *
 * <p>Example 1:
 *
