...
/**
 * Created by gouthamvidyapradhan on 09/02/2018. In a given integer leetcode.array nums, there is always
 * exactly one largest element.
 *
 * <p>Find whether the largest element in the leetcode.array is at least twice as much as every other number
 * in the leetcode.array.
 *
 ...
 * other number in the leetcode.array x, 6 is more than twice as big as x. The index of value 6 is 1, so we
 * return 1.
 *
 * <p>Example 2:
 *
