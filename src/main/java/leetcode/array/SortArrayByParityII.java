...
/**
 * Created by gouthamvidyapradhan on 20/08/2019 Given an leetcode.array A of non-negative integers, half of
 * the integers in A are odd, and half of the integers are even.
 *
 * <p>Sort the leetcode.array so that whenever A[i] is odd, i is odd; and whenever A[i] is even, i is even.
 *
 * <p>You may return any answer leetcode.array that satisfies this condition.
 *
 * <p>Example 1:
 *
