 ...
 *
 * <p>Given an leetcode.array flowers consists of number from 1 to N. Each number in the leetcode.array represents the
 ...
 * Note: The given leetcode.array will be in the range [1, 20000].
 *
 * <p>Solution: O(n log n). Maintain a leetcode.tree-set of bloomed flowers and for every element in the
 * leetcode.array find the upper and lower bound bloomed flowers and calculate their difference with the
