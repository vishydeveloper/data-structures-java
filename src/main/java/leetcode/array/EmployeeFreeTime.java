 ...
 * each employee. Merge all the intervals to form a single merged leetcode.array, now by using this leetcode.array
 * form a result leetcode.array with the intervals which form the free time.
 */
