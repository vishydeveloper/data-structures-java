...
/**
 * Created by gouthamvidyapradhan on 25/03/2017. Given a non-empty leetcode.array of integers, return the
 * third maximum number in this leetcode.array. If it does not exist, return the maximum number. The time
