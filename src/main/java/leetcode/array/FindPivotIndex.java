...
/**
 * Created by gouthamvidyapradhan on 06/08/2019 Given an leetcode.array of integers nums, write a method that
 * returns the "pivot" index of this leetcode.array.
 *
 ...
 * the range [-1000, 1000].
 *
 * <p>Solution: O(N) maintain a prefix and posfix sum leetcode.array and then use this to arrive at the
 * answer.
 */
