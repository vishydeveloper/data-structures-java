...
/**
 * Created by gouthamvidyapradhan on 08/05/2019 Given a binary leetcode.array, find the maximum number of
 * consecutive 1s in this leetcode.array if you can flip at most one 0.
 *
 ...
 * Note:
 *
 * <p>The input leetcode.array will only contain 0 and 1. The length of input leetcode.array is a positive integer and
 ...
 *
 * <p>Solution: O(N) Maintain a left and right auxiliary leetcode.array with counts of contagious 1's from
 * both directions. Now, iterate through the leetcode.array and flip a 0 to 1 and sum up left and right
