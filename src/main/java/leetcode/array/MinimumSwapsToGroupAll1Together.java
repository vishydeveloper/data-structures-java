...
/**
 * Created by gouthamvidyapradhan on 23/10/2019 Given a binary leetcode.array data, return the minimum number
 * of swaps required to group all 1’s present in the leetcode.array together in any place in the leetcode.array.
 *
 * <p>Example 1:
 *
 ...
 * Example 2:
 *
 * <p>Input: [0,0,0,1,0] Output: 0 Explanation: Since there is only one 1 in the leetcode.array, no swaps
 * needed. Example 3:
 *
 ...
 * 1s should occupy a small window in a leetcode.array, this window could be in any part of the leetcode.array - a
