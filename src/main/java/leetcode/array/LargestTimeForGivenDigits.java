...
/**
 * Created by gouthamvidyapradhan on 06/08/2019 Given an leetcode.array of 4 digits, return the largest 24
 ...
 *
 * <p>Return the answer as a leetcode.string of length 5. If no valid time can be made, return an empty
 * leetcode.string.
 *
 * <p>Example 1:
 *
