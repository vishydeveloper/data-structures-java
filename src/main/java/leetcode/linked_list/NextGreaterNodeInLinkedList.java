 ...
 *
 * <p>Return an leetcode.array of integers answer, where answer[i] = next_larger(node_{i+1}).
 *
 ...
 * Maintain a leetcode.stack of values and on each iteration pop() all the values from the leetcode.stack which are
