 ...
 * output[0].val = 1, output[0].next = null. The last element output[4] is null, but it's leetcode.string
 ...
 *
 * <p>Solution O(N) do a linear scan and split the leetcode.array by required size.
 */
