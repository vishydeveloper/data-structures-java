...
public class BreadthFirstSearchAdjacencyListIterativeTest {
  ...
  public void testSingletonGraph() {
    int n = 1;
    List<List<BreadthFirstSearchAdjacencyListIterative.Edge>> graph = BreadthFirstSearchAdjacencyListIterative.createEmptyGraph(n);
  ...
  public void testTwoNodeGraph() {
    int n = 2;
    List<List<BreadthFirstSearchAdjacencyListIterative.Edge>> graph = BreadthFirstSearchAdjacencyListIterative.createEmptyGraph(n);
    BreadthFirstSearchAdjacencyListIterative.addUnweightedUndirectedEdge(graph, 0, 1);
    solver = new BreadthFirstSearchAdjacencyListIterative(graph);
  ...
  public void testThreeNodeGraph() {
    ...
    List<List<BreadthFirstSearchAdjacencyListIterative.Edge>> graph = BreadthFirstSearchAdjacencyListIterative.createEmptyGraph(n);
    BreadthFirstSearchAdjacencyListIterative.addUnweightedUndirectedEdge(graph, 0, 1);
    BreadthFirstSearchAdjacencyListIterative.addUnweightedUndirectedEdge(graph, 2, 1);
    solver = new BreadthFirstSearchAdjacencyListIterative(graph);
  ...
  public static double[][] generateRandomGraph(List<List<BreadthFirstSearchAdjacencyListIterative.Edge>> graph1, int n) {
    ...
    for (int i = 0; i < numEdges; i++) {
      ...
      int v = (int) (random() * n);
      if (!edgeMatrix[u][v]) {
        BreadthFirstSearchAdjacencyListIterative.addUnweightedUndirectedEdge(graph1, u, v);
